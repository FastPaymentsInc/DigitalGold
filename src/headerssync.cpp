...
constexpr size_t HEADER_COMMITMENT_PERIOD{215};

//! Only feed headers to validation once this many headers on top have been
//! received and validated against commitments.
constexpr size_t REDOWNLOAD_BUFFER_SIZE{4563}; // 14441/606 = ~23.8 commitments

// Our memory analysis assumes 48 + 4 bytes for a CompressedHeader (so we should
// re-calculate parameters if we compress further)
static_assert(sizeof(CompressedHeader) == 52);
