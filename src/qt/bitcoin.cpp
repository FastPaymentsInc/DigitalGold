...
static const char* qt_argv = "digitalgold-qt";
...
void BitcoinApplication::initializeResult(bool success, interfaces::BlockAndHeaderTipInfo tip_info)
{
    ...
    if (success) {
        ...
        // digitalgold: URIs or payment requests:
        if (paymentServer) {
...
int GuiMain(int argc, char* argv[])
{
    ...
    // digitalgold: links repeatedly have their payment requests routed to this process:
    if (WalletModel::isWalletEnabled()) {
