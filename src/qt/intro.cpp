    ...
    m_blockchain_size_gb(blockchain_size_gb)
{
    ...
    this->setStyleSheet(R"(
        ...
        /* Label Styling */
        QLabel#welcomeLabel, QLabel#storageLabel, QLabel#ExplanationLabel1, QLabel#ExplanationLabel2 {
        ...
        /* RadioButton Indicator Styling (Optional) */
...
bool Intro::showIfNeeded(bool& did_show_intro)
{
     ...
     * override -datadir in the digitalgold.conf file in the default data directory
