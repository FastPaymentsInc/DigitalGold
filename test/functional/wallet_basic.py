...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 DGD from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 20000 DGD in block rewards plus fees, but
        ...
        # Send 10 DGD with subtract fee from amount
        ...
        # Sendmany 10 DGD with subtract fee from amount
        ...
        if not self.options.descriptors:
            ...
            # This will raise an exception for attempting to get the private key of an invalid digitalgold address
            assert_raises_rpc_error(-5, "Invalid digitalgold address", self.nodes[0].dumpprivkey, "invalid")

            # This will raise an exception for attempting to set a label for an invalid digitalgold address
            assert_raises_rpc_error(-5, "Invalid digitalgold address", self.nodes[0].setlabel, "invalid address", "label")

            # This will raise an exception for importing an invalid address
            assert_raises_rpc_error(-5, "Invalid digitalgold address or script", self.nodes[0].importaddress, "invalid")
