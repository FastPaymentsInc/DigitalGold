...
BITCOIND=${BITCOIND:-$BINDIR/usdgd}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/usdg.conf}
...
then
  ...
  echo -e "To safely generate a usdg.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example usdg.conf file in share/examples/'
...
##
## usdg.conf configuration file.
## Generated by contrib/devtools/gen-usdg-conf.sh.
##
...
# parse the output from usdgd --help
