...
BITCOIND=${BITCOIND:-$BINDIR/digitalgold}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/digitalgold.conf}
...
then
  ...
  echo -e "To safely generate a digitalgold.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example digitalgold.conf file in share/examples/'
...
# parse the output from digitalgold --help
