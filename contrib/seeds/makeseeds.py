...
def main():
    ...
    # Filter out hosts with multiple digitalgold ports, these are likely abusive
    ips = filtermultiport(ips)
    print(f'{ip_stats(ips):s} Filter out hosts with multiple digitalgold ports', file=sys.stderr)
