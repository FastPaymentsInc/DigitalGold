...
```
digitalgold -i2psam=127.0.0.1:7656
```
...
debug log about your I2P configuration and connections. Run `digitalgold-cli help
...
`digitalgold-cli -addrinfo` to see the number of I2P addresses known to your node.
...
To see which I2P peers your node is connected to, use `digitalgold-cli -netinfo 4`
or the `getpeerinfo` RPC (e.g. `digitalgold-cli getpeerinfo`).
