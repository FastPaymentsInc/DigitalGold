...
The interface runs on the same port as the JSON-RPC interface, by default port 7634 for mainnet, port 17634 for testnet,
and port 27634 for regtest.
...
Example:
```
$ curl localhost:7634/rest/getutxos/checkmempool/b2cdfd7b89def827ff8af7cd9bff7627ff72e5e8b0f71210f92ea7a4000c5d75-0.json 2>/dev/null | json_pp
{
   "chainHeight" : 325347,
...
Risks
-------------
Running a web browser on the same node with a REST enabled usdgd can be a risk. Accessing prepared XSS websites could read out tx/block data of your node by placing links like `<script src="http://127.0.0.1:7634/rest/tx/1234567890.json">` which might break the nodes privacy.
